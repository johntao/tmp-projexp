...
Infinitode 遊戲解析器	個人專案	Office	Office	Info-viz	1	0	3	["GCP OCR","Google Spreadsheet","Google Photos"]	透過 OCR 擷取遊戲截圖數據，自動整理至試算表進行分析	
...
網站組態設定查詢工具	新專案	Desktop	Admin	Info-viz	0	1	1	[".NET","c#","winform"]	開發 CLI 工具反向查詢網站組態設定檔	
